...
def rendering(list_ids, robot_list, graph, n):
    with open("dot/graphe"+str(n)+".dot", 'w') as f:
        ...
        for i in range(len(list_ids)):
            ...
            if robot_list[i]["state"] == "awake":
                ...
                line += "red]"
            elif robot_list[i]["state"] == "reserved":
                line += "blue]"
            f.write(line)
...
if __name__ == "__main__":
    ...
    rendering(list_ids, robot_list, graph, 0)
